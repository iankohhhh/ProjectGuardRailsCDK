...
class PrivateApiGateway(Construct):
    ...
    def __init__(self, scope: Construct, id:str, 
        ...
        **kwargs):
        ...
        tenant_items_response_model = self.private_api_gateway.add_model("ResponseModel",
            content_type="application/json",
            model_name="TenantItemsModel",
        ...
        successful_method_response = apigw.MethodResponse(
            status_code="200",
        ...
        resource_getalltenantitems.add_method(
            ...
            method_responses = [successful_method_response]
            ) #/getalltenantitems
        ...
        resource_sqlinjection = self.private_api_gateway.root.add_resource("sqlinjectionexample")
        resource_sqlinjection.add_method(
            "GET", apigw.LambdaIntegration(sqlinjection_lambda),
            method_responses = [successful_method_response]
            ) #/deleteitem
